...
#     np.save(os.path.join(base_path, 'OG_formatted_{}_labels_obs.npy'.format(phase)), label_matrix_obs)
...
for i in range(1, NUM_REALIZATIONS + 1):
    for phase in ['train', 'val']:
        ...
        # save observed labels:
        file_name = 'cvpr_{}_formatted_{}_{}_{}_labels_obs.npy'.format(args.dataset,
                                                                  phase,
                                                                  'uniform',
                                                                  i)
